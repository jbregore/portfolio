...
// import { HomeIcon, InfoIcon, CodeIcon, WebIcon, ContactMailIcon } from '@mui/icons-material/';
    ...
    return (
        <div style={{ display: 'flex' }}>
            <div style={{
                ...
                <Fab aria-label="add" variant="extended" style={{
                    height: 40, backgroundColor: "#555",
                    color: '#fff', paddingTop: 10
                }}>
                    <Link to="home" spy={true} smooth={true}><HomeIcon sx={{ mr: 2 }} /></Link>
                    <Link to="about" offset={-120} spy={true} smooth={true}><InfoIcon sx={{ mr: 2 }} /></Link>
                    <Link to="skills" offset={-90} spy={true} smooth={true}><CodeIcon sx={{ mr: 2 }} /></Link>
                    <Link to="project" offset={-90} spy={true} smooth={true}><WebIcon sx={{ mr: 2 }} /></Link>
